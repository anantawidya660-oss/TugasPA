...
class Config:
    ...
    # ========================================
    # TIDB CLOUD CONFIGURATION - BACA DARI .env
    # ========================================
    TIDB_HOST = os.getenv('TIDB_HOST')
    TIDB_PORT = os.getenv('TIDB_PORT', '4000')
    TIDB_USER = os.getenv('TIDB_USER')          # ← HARUS dari .env
    TIDB_PASSWORD = os.getenv('TIDB_PASSWORD')  # ← HARUS dari .env
    TIDB_DATABASE = os.getenv('TIDB_DATABASE', 'tugas_db')  # ← Default tugas_db
