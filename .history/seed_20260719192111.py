...
with app.app_context():
    print("=" * 60)
    print("🔄 UPDATE DATA: ANANTA → YUSUF")
    print("=" * 60)
    ...
    # ========================================
    # 2. UPDATE SKILLS (Hapus lama + buat baru)
    # ========================================
    print("\n📌 2. Update Skills...")
    Skill.query.delete()
    ...
    db.session.commit()
    print(f"   ✅ {len(skills_data)} Skills berhasil diupdate!")
    
    # ========================================
    # 3. UPDATE EXPERIENCES (Hapus lama + buat baru)
    # ========================================
...
• Visual Paradigm""",
    ...
    for data in exp_data:
        ...
        db.session.add(exp)
    db.session.commit()
    print(f"   ✅ {len(exp_data)} Experiences berhasil diupdate!")
    
    # ========================================
    # 4. UPDATE PROJECTS (Hapus lama + buat baru)
    # ========================================
    print("\n📌 4. Update Projects...")
    ...
    db.session.commit()
    print(f"   ✅ {len(proj_data)} Projects berhasil diupdate!")
